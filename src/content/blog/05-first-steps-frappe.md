...
**Ready for the next challenge?** Check out our [ERPNext Installation Guide](/blog/04-install-frappe-erpnext-docker) to learn how to work with the full ERPNext application built on Frappe.
